...
import { HiChartBar, HiCheckCircle, HiArrowRight, HiExternalLink, HiX, HiZoomIn, HiChevronLeft, HiChevronRight, HiLockClosed, HiUser, HiKey, HiHome } from 'react-icons/hi'
  ...
  const features = [
    {
      ...
      description: 'Behalten Sie den Überblick über alle laufenden Projekten in Echtzeit'
    },
    {
  ...
  const screenshots = [
    {
      ...
      description: 'Hauptdashboard mit allen laufenden Projekten',
      image: '/dashboard.png',
      alt: 'GentleTrack Dashboard Übersicht'
    },
    {
      id: 2,
      title: 'Projektverwaltung',
      description: 'Detaillierte Ansicht aller Projekte mit Status',
      image: '/projects.png',
      alt: 'GentleTrack Projektverwaltung'
    },
    {
      id: 3,
      title: 'Admin-Panel',
      description: 'Administrationsoberfläche für Benutzer- und Einstellungsverwaltung',
      image: '/admin.png',
      alt: 'GentleTrack Admin-Panel'
    }
  ]

  const liveDemoUrl = "https://f7e2b27f.gentle-track-ui.pages.dev/"

  const adminCredentials = {
    email: "admin@gentletrack.com",
    password: "123456"
  }
        ...
        <section className="max-w-[1400px] mx-auto px-8 lg:px-16">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-gradient-to-r from-tropical-indigo to-aquamarine text-oxford-blue font-bold rounded-full shadow-lg shadow-tropical-indigo/30 hover:shadow-tropical-indigo/50 transition-all duration-300 inline-flex items-center gap-3"
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-aquamarine">
                      Testzugang für die Administrationsoberfläche
                    </p>
                  </div>
                </div>
                <motion.div
          ...
          >
            ...
            <motion.div
              ...
              className={`mt-6 p-5 rounded-2xl ${actualTheme === 'dark' ? 'bg-white/5' : 'bg-gray-100'} border ${borderColor} text-center`}
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                <div className="w-2.5 h-2.5 rounded-full bg-aquamarine animate-pulse" />
                <p className={`text-sm font-medium ${textColor}`}>
                  Klicken Sie auf ein Bild um es zu vergrößern
                </p>
              </div>
              <p className={`text-xs ${mutedColor} max-w-2xl mx-auto mb-4`}>
                Die Screenshots zeigen verschiedene Ansichten von GentleTrack.
              </p>
              <motion.a
                href={liveDemoUrl}
                target="_blank"
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className={`inline-flex items-center gap-2 px-4 py-2 ${actualTheme === 'dark' ? 'bg-white/10 hover:bg-white/20' : 'bg-gray-200 hover:bg-gray-300'} rounded-full text-xs font-medium transition-colors duration-300`}
              >
          ...
          >
            ...
            <h2 className={`text-5xl font-black mb-3 ${textColor}`}>
              Ab 9€<span className={`text-2xl font-normal ${mutedColor}`}>/Monat</span>
            </h2>
