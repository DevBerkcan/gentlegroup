...
import { HiChartBar, HiCheckCircle, HiArrowRight, HiExternalLink, HiX, HiZoomIn, HiChevronLeft, HiChevronRight, HiLockClosed, HiUser, HiKey } from 'react-icons/hi'
...
export default function GentleTrackPage() {
  ...
  // Deine Screenshots aus dem public Ordner
  const screenshots = [
    {
      id: 1,
  ...
  // Live Demo URL von der verlinkten App
    ...
    <>
      <main className={`min-h-screen ${bgColor} pt-32 pb-20`}>
        ...
        <section className="max-w-[1400px] mx-auto px-8 lg:px-16">
          ...
          {/* Screenshots Section - UNVERÄNDERT */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              ...
              <p className={`text-sm ${mutedColor} max-w-2xl mx-auto mb-4`}>
                Die Screenshots zeigen verschiedene Ansichten von GentleTrack. Klicken Sie auf ein Bild, um es in voller Größe zu sehen.
              </p>
              <motion.a
                href={liveDemoUrl}
                target="_blank"
