...
const BEAUTY_PROJECTS = [
  {
    ...
    tags: ['Next.js', 'Online-Buchung', 'Google Analytics'],
    ...
    outcome: [
      ...
      '24/7 Online-Buchung und automatisierte Rückrufe'
    ],
    implementation: [
  ...
  },
  {
    ...
    outcome: [
      ...
      'Direkte Online-Anfragen für Laserbehandlungen innerhalb weniger Klicks'
    ],
    implementation: [
      'WordPress + Divi mit eigenem Multi-Standort-Modul und Standort-Switcher',
      'Schema.org & Local SEO Setup inkl. Bewertungs-Widgets',
      'Termin-Buttons auf jeder Sektion für schnelle Conversion'
    ]
  },
  {
    ...
    implementation: [
      'Corporate Design & Storytelling mit Moodboards',
...
export default function BeautyPortfolio() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-6 mb-10">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 text-gray-600 text-sm md:text-base">
                {[ 'spezialisiert auf Beauty & Wellness', 'Online-Buchung integriert', 'Google-ready' ].map(text => (
            ...
            {[
              {
                ...
                description: 'Next.js oder WordPress – immer mit klarer Conversational Flow, Buchung & Conversion-Optimierung.',
                color: 'from-purple-500 to-indigo-600'
              },
              {
                icon: '🧮',
              ...
              {
                icon: '📅',
                title: 'Online-Buchung & Automation',
                description: '24/7 Terminbuchung, Warteliste & automatisierte Kommunikation.',
                color: 'from-rose-500 to-pink-600'
              },
              {
                icon: '📊',
      ...
      {/* GentleCalc Showcase Section */}
      <section className="relative py-20 lg:py-32 bg-gradient-to-br from-pink-50 to-purple-50 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-pink-500/10 rounded-full blur-[120px]" />
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-8 lg:px-16">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <p className="inline-flex items-center gap-2 px-6 py-3 bg-white border border-pink-500/30 rounded-full mb-6">
              <HiSparkles className="w-5 h-5 text-pink-500" />
              <span className="text-pink-600 font-semibold text-sm">Intelligenter Preisrechner</span>
            </p>
            <h2
              className="text-[clamp(2rem,5vw,3.5rem)] font-bold mb-6"
              style={{ fontWeight: 800, letterSpacing: '-0.02em' }}
            >
              GentleCalc - <span className="text-pink-500">Dein intelligenter Preisrechner</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Kunden berechnen ihre Behandlung selbst - keine Preisdiscussionen mehr. Upsell-Logik für Pakete und Kombi-Angebote integriert.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h3 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6" style={{ fontWeight: 800, letterSpacing: '-0.02em' }}>
                Wie GentleCalc dein Studio transformiert
              </h3>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Unser intelligenter Preisrechner führt Kunden durch dein Behandlungsportfolio, erklärt Preise transparent und schlägt automatisch passende Pakete vor.
              </p>
              
              <div className="space-y-6 mb-10">
                {[
                  {
                    title: 'Transparente Preis-Kommunikation',
                    description: 'Kunden verstehen genau, was sie für ihr Geld bekommen - weniger Nachfragen, mehr Buchungen.',
                    icon: '💬'
                  },
                  {
                    title: 'Automatisches Upselling',
                    description: 'Intelligente Logik schlägt passende Pakete vor - ohne Druck, mit mehr Umsatz.',
                    icon: '📈'
                  },
                  {
                    title: 'Lead-Qualifizierung',
                    description: 'Bereits vor dem ersten Kontakt wissen wir, was der Kunde sucht - effizientere Beratungen.',
                    icon: '🎯'
                  },
                  {
                    title: '24/7 Verfügbar',
                    description: 'Kunden können jederzeit Preise berechnen - auch wenn dein Studio geschlossen ist.',
                    icon: '⏰'
                  }
                ].map((feature, index) => (
                  <motion.div
                  ...
                  >
                    <div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-500 rounded-xl flex items-center justify-center text-white text-xl shadow-lg">
                      {feature.icon}
                    </div>
                    <div>
              ...
              <div className="bg-white rounded-3xl border border-gray-200 shadow-2xl p-8">
                <div className="mb-8">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900">GentleCalc Preisrechner</h4>
                      <p className="text-sm text-gray-500">HydraFacial Behandlung</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Behandlung auswählen</label>
                      <div className="grid grid-cols-2 gap-3">
                        {['Basic', 'Deluxe', 'VIP', 'Combo'].map(option => (
                          <div key={option} className="p-3 border-2 border-gray-200 rounded-xl text-center cursor-pointer hover:border-pink-500 hover:bg-pink-50 transition-all">
                            <p className="font-semibold text-gray-900">{option}</p>
                            <p className="text-sm text-gray-500">{option === 'VIP' ? '€299' : option === 'Combo' ? '€399' : '€199'}</p>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    {/* Add-ons */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Zusatzleistungen</label>
                      <div className="space-y-2">
                        {[
                          { name: 'Tiefenreinigung', price: '+ €49' },
                          { name: 'LED-Lichttherapie', price: '+ €29' },
                          { name: 'Augenbereich', price: '+ €39' }
                        ].map(addon => (
                          <div key={addon.name} className="flex items-center justify-between p-3 border border-gray-200 rounded-xl hover:bg-gray-50">
                    ...
                    <div className="pt-6 border-t border-gray-200">
                      ...
                      <div className="flex justify-between items-center mb-3">
                        <span className="text-gray-700">Paket-Rabatt (10%)</span>
                        <span className="text-green-600 font-semibold">- €20</span>
                      </div>
                      <div className="flex justify-between items-center text-lg font-bold">
                        <span>Gesamtpreis</span>
                        <span className="text-2xl text-pink-600">€179</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <button className="w-full py-3 bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all">
                    Jetzt Termin buchen
                  </button>
                  <p className="text-xs text-gray-500 mt-3">Preise inkl. MwSt. Keine versteckten Kosten.</p>
                </div>
              </div>
              
              {/* Success Badge */}
              <div className="absolute -bottom-4 -right-4 bg-white border border-gray-200 shadow-xl rounded-2xl p-4 w-56">
                <p className="text-xs text-gray-500 mb-1">Durchschnittlicher Warenkorb</p>
                <p className="text-2xl font-bold text-gray-900">+28%</p>
                <p className="text-xs text-green-500 font-semibold">mit GentleCalc</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="relative py-20 lg:py-32 bg-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-8 lg:px-16">
            ...
            {[
              {
                ...
                color: 'from-pink-500 to-rose-600',
                benefits: ['Automatische Bestätigungen', 'Kalender-Sync', 'Mobile Optimiert']
              },
              {
                icon: '🧮',
                name: 'GentleCalc',
              ...
              },
              {
                icon: '🎯',
                name: 'GentleConvert',
                tagline: 'Conversion-Optimierung',
                description: 'A/B-Testing, Heatmaps und Analytics speziell für Beauty-Studios.',
                color: 'from-rose-500 to-pink-600',
                benefits: ['Heatmap-Analyse', 'A/B Testing', 'Conversion-Tracking']
              }
            ].map((product, index) => (
              <motion.div
                key={product.name}
          ...
          >
            <p className="text-gray-600 mb-6">Alle Produkte auf Beauty-Studios optimiert</p>
            <Link href="/#contact">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Wir integrieren Buchung, Wartelisten und automatische Kommunikation so, dass Interessentinnen nie lange suchen.
                Jede Sektion deiner Seite hat eine klare Aktion – Termin, Beratung oder Preisberechnung.
              </p>
              <ul className="space-y-4 text-gray-700 mb-8">
                {[
                  'Direkte Verfügbarkeiten & automatische Bestätigung',
                  'Funnel für Neukunden inkl. GentleCalc-Integration',
              ...
              <div className="bg-white rounded-3xl border border-gray-200 shadow-2xl p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { treatment: 'Medical Needling', time: '15:15', status: 'automatisches Follow-up' }
                  ].map(slot => (
        ...
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
            ...
            {[
              {
                ...
                image: '/skinbloom.webp',
                quote: 'Seit dem Launch unserer neuen Website haben wir 180% mehr Online-Anfragen. Die automatische Preisberechnung spart uns täglich Stunden!',
                rating: 5,
          ...
          >
            {[
              ...
              { value: '24/7', label: 'Online-Buchung verfügbar' }
            ].map((stat, index) => (
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Fixpreise ohne versteckte Kosten. Alle Pakete inklusive SSL und 3 Monate Support.
            </p>
          </motion.div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer: 'Eine Basis-Website ist in 2-3 Wochen live. Komplettlösungen mit Branding und Kampagnen benötigen 4-6 Wochen. Der Launch erfolgt immer nach deiner finalen Freigabe.'
              },
              {
                question: 'Funktioniert alles auf mobilen Geräten?',
                answer: 'Ja, absolut. Alle unsere Websites sind mobile-first optimiert und passen sich perfekt an Smartphones und Tablets an. Die meisten unserer Kunden buchen ihre Termine mobil.'
              },
              {
                question: 'Welche Buchungssysteme integriert ihr?',
                answer: 'Wir arbeiten mit Calendly, Acuity, SimplyBook.me und unserem eigenen GentleBook. Alternativ integrieren wir dein bestehendes System. Alle Lösungen sind auf Beauty-Studios optimiert.'
              },
              {
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  'Erprobte Preis-Kommunikationsstrategien',
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-2xl">
                ...
                <ul className="space-y-4 text-gray-700">
                  {[
                    ...
                    { label: 'Preis-Kommunikation', value: 'Verstehen Kunden deine Preise?' }
                  ].map(item => (
        ...
        <div className="max-w-[1200px] mx-auto px-8 lg:px-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
            {[
              ...
              { icon: '⚡', label: 'Schnelle Ladezeiten', desc: '<2 Sekunden' },
              { icon: '📱', label: 'Mobile Optimiert', desc: 'Responsive Design' },
              { icon: '🏆', label: 'Google-ready', desc: 'Optimiert für SEO' }
            ].map((badge, index) => (
              <motion.div
                key={badge.label}
                initial={{ opacity: 0, scale: 0.9 }}
