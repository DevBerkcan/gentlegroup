...
export default function AGB() {
  useEffect(() => {
    ...
    fetch(`https://app.cockpit.legal/api/cockpit/resources/legaldocumentshare/ae0638ba4db0d2b0c0d5c75785034e8c/document/render/html?language=de`)
            ...
            <noscript>
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mt-8">
                <p className="text-gray-700 mb-4">
                  ...
                  <a
                    target="_blank"
                    href="https://app.cockpit.legal/api/cockpit/resources/legaldocumentshare/ae0638ba4db0d2b0c0d5c75785034e8c/document/render/html?language=de"
