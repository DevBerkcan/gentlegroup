...
const AIQuestionnairePage = () => {
  ...
  const questions: Question[] = useMemo(
    () => [
      ...
      {
        question: 'Welche Funktionen sind Ihnen besonders wichtig?',
        key: 'features',
        type: 'textarea',
        placeholder: 'Zum Beispiel: Login, Dashboard, Zahlungsabwicklung, Admin, API, KI-Chat.',
      },
      {
  ...
  return (
    <div className="min-h-screen bg-black text-ghost-white">
      <div className="relative w-full">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 py-6 sm:py-10 flex flex-col min-h-[calc(100dvh-80px)]">
          <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} className="shrink-0 mb-4 sm:mb-6 pb-4 sm:pb-6 border-b border-ghost-white/10">
