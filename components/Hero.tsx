            ...
            <div className="w-full max-w-7xl mx-auto px-4 mb-32 sm:mb-36 lg:mb-40 relative">
              ...
              <div className="flex flex-col items-center">
                ...
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={contentControls}
                  className="text-lg sm:text-xl lg:text-2xl text-ghost-white/95 leading-relaxed font-medium min-h-[40px] sm:min-h-[50px] lg:min-h-[60px] flex items-center justify-center"
                >
